/// <reference path="emoji-dialog.js" />
/// <reference path="emoji-dialog.js" />
/*!
    ...
    var factory = function (exports) {
        ...
        exports.fn.emojiDialog = function () {
                        ...
                        for (var x = 0; x < rowNumber; x++) {
                            ...
                            if (typeof emoji !== "undefined" && emoji !== "") {
                                ...
                                if (type === "github-emoji") {
                                    ...
                                    var newsrc = "/Areas/GuanWang/editormd/plugins/emoji-dialog/emoji/";
            ...
            if (emojiData.length < 1) {
                ...
                $.getJSON("/Areas/GuanWang/editormd/plugins/emoji-dialog/emoji.json?temp=" + Math.random(), function (json) {
