...
public static class MailHelper
{
    ...
    private readonly static string SmtpUsername = "liujiaxioo@163.com";
    private readonly static string SmtpDisplayName = "捧起网 - 找回密码";
    private readonly static string SmtpPassword = "ljx163yx@159263";
    ...
    /// </summary>
    /// <param name="id"></param>
    public static string CreateHtmlPage(string username, string pwd)
    {
        string html = HttpContext.Current.Request.MapPath("/Templates/sendemail.html");
        html = File.ReadAllText(html);
        html = html.Replace("$Name", username).Replace("$Pwd", pwd).Replace("$Time", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
        return html;
    }
    #endregion
}